...
Developed with **roblox-ts** and **Flamework**.<br/>
Designed to be **reliable**, highly effective against exploits, and thoroughly tested in production to guarantee **zero false positives**.
...
**Dex Debugger**
> Detects the use of Dex, a tool exploiters use to view game files exactly like the Roblox Studio Explorer, allowing them to read your script codes.
